...
/**
 *  Class is used Add, Subtract and Multiply adjustment operations for a given product.
 *
 */
...
public class PriceAdjustmentDetails {
    ...
    private ProductDetials product;

    
    public PriceAdjustmentDetails(ProductDetials product) {
    ...
    */
    ...
    public String adjustmentReport(){
        String adjustmentReport = String.format(
                "Processed -> %s %.2fp to %d %s and price adjusted from %.2fp to %.2fp",
